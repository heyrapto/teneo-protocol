...
export const VisionSection = () => {
    return (
        <section className="relative w-full bg-[#09090A] overflow-hidden">
            ...
            <div className="w-full max-w-[1920px] mx-auto px-8 lg:px-16 pt-32 pb-0 relative z-10">
                {/* Top Content */}
                <div className="grid grid-cols-12 gap-8 mb-32 items-center">
                    {/* Left Text */}
                    <div className="col-span-12 lg:col-span-5">
                        <h2 className="text-[3.5rem] leading-[1.1] font-normal text-white mb-8">
                            Let&apos;s Transform<br />
                ...
                <div className="mb-12">
                    <h3 className="text-[2rem] font-normal text-white flex items-center gap-3">
                        ...
                        <span className="bg-[#1F5CFF] text-white px-3 py-1 rounded-sm text-xl font-medium tracking-wide">
                            3 Steps
                        </span>
                    </h3>
                </div>
