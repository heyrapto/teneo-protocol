...
export const PartnersSection = () => {
    return (
        <section className="relative w-full bg-[#0c4cf5] py-10 overflow-hidden">
            ...
            <div className="container mx-auto px-8 lg:px-16 flex items-center relative z-10 h-full min-h-[400px]">
                <div className="grid grid-cols-12 w-full gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-3">
                        <h2 className="text-[3rem] leading-none font-normal text-white">
                            Partners
                        </h2>
                    </div>

                    {/* Partners Grid */}
                    <div className="col-span-12 lg:col-span-9 grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-4 items-center">
                        {partners.map((partner, i) => (
                            <div key={i} className="flex items-center justify-center relative h-[80px] w-full">
                                <Image
                                    src={partner.src}
                                    alt={partner.name}
                                    fill
